...
import type { Interpolate, ParamsOf } from './index.js'
  ...
  describe('Params', () => {
    it('parses params', () => {
      Test.checks([
        ...
        Test.check<
          ParamsOf<'/a/:b/c/:d?'>,
          { readonly b: string; readonly d?: string },
          Test.Pass
        >(),
        // Zero or more
        ...
        Test.check<
          ParamsOf<'/a/(.*)+'>,
          { readonly 0: readonly [string, ...Array<string>] },
          Test.Pass
        >(),
        // Prefix
  ...
  describe('Interpolate', () => {
    it('interpolates paths', () => {
      Test.checks([
        ...
        Test.check<Interpolate<':test*', { test: ['b'] }>, '/b', Test.Pass>(),
        Test.check<Interpolate<':test*', { readonly test: readonly ['b', 'c'] }>, '/b/c', Test.Pass>(),
        // One or more
        Test.check<Interpolate<'/a/:foo+', { foo: ['b'] }>, '/a/b', Test.Pass>(),
        ...
        // Prefixed with static text
        Test.check<
          Interpolate<'/foo/{foo-:fooId}/bar/{bar-:barId}', { fooId: 'foo'; barId: 'bar' }>,
