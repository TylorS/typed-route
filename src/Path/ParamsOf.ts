 ...
 * @since 1.0.0
 */
export type HasParams<T extends string> = A.Equals<T, string> extends 1
  ? false
 ...
 * @since 1.0.0
 */
export type ParamsList<T extends string> = A.Equals<T, string> extends 1
  ? [params?: {}]
  : [ParamsOf<T>] extends [infer R]
    ? [keyof R] extends [never]
      ? [params?: {}]
...
type ToParams<T extends ReadonlyArray<any>, Params = {}, R = unknown> = T extends readonly [
  infer H,
  ...infer Tail,
]
...
type AstToParams<T, Params = {}> = T extends ModifierNode<infer M, infer S>
          ...
          : T extends PrefixNode<infer _, infer S extends SegmentAST>
            ...
            : T extends SuffixNode<infer S extends SegmentAST, infer _>
              ...
              : T extends QueryParamsNode<
                ...
                : T extends QueryParamNode<infer _Name, infer Value extends SegmentAST>
                  ? AstToParams<Value>
                  : {}
